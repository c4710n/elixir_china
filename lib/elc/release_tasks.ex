defmodule Elc.ReleaseTasks do
  ...
  Run a function manually:
       ...
       _build/prod/rel/$RELEASE_NAME/bin/$RELEASE_NAME eval "Elc.ReleaseTasks.migrate()"

       _build/prod/rel/$RELEASE_NAME/bin/$RELEASE_NAME eval "Elc.ReleaseTasks.rollback()"

       _build/prod/rel/$RELEASE_NAME/bin/$RELEASE_NAME eval "Elc.ReleaseTasks.seed()"
  ...
  case $RELEASE_COMMAND in
      start*)
          "$RELEASE_ROOT/bin/$RELEASE_NAME" eval "Elc.ReleaseTasks.migrate()"
          ;;
      *)
          ;;
  esac
