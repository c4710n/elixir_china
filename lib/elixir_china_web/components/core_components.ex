defmodule ElixirChinaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ElixirChinaWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ElixirChinaWeb.Gettext, "errors", msg, opts)
    # end
